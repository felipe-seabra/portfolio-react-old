        ...
        <div className="container">
          <div className="main-sobre row">
            ...
            <div className="Text-sobre mt-3">
              <h2>Sobre Mim</h2>
              <p>
                Natural de Presidente Prudente (SP), tenho aproximadamente 10 anos de experiência
                atuando em diversas áreas de tecnologia em educação.
              </p>
              <p>
                Apesar de hoje me identificar mais com o<strong>Front-end</strong>, vejo que não há
